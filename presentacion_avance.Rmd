...
- in summary:
    ...
    - The variables available for the procedure are not so good
    - The methodology is can be criticized: **non-structural variables**
...
- The **labeling is not trivial**. It implies a deep knowledge of income measurement in surveys.

--

- Our classifier obtains F1-score of 0, **predicting the absence of the attribute in all cases**.
