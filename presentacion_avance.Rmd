...
### Focus on the the workflow 

--

- Automation of image downloading (almost ready)  

- Labeling (automation in progress)

- Data preprocessing

- Training (basic model and fine-tuning)
...
- **Integration of known external information** to the images, such as the district.
